...
<div class="content">
	...
	<?php $l = new DAO();
	$usr = $l->listarEmpresas();
	echo '<h4 class="card-title">Usuarios del sistema: '.count($usr).'</h4>';
	?>              
                                        ...
                                        <tbody>
                                            	<?php
													...
													for($i=0; $i<count($usr); $i++){
														...
														echo '<td>'.$e->getDescr().'</td>';
														echo '<td>'.$e->getEstado().'</td>';
														echo '<td><input type="button" class="btn btn-info btn-fill" value="Ver detalles"></td>';
													}
													?>
