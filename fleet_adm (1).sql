...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 31-08-2019 a las 01:58:13
...
(1, 'admin@fleetran.cl', 'e10adc3949ba59abbe56e057f20f883e');
...
CREATE TABLE `estados` (
  ...
  `detalle_estado` varchar(50) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
INSERT INTO `estados` (`id_estado`, `detalle_estado`) VALUES
(1, 'Ingreso exitoso'),
(2, 'Datos incorrectos'),
(3, 'Bloqueo de cuenta'),
(4, 'Caracteres invalidos'),
(5, 'Campos vacios'),
(6, 'Usuario sin licencia');
...
INSERT INTO `ingreso` (`Id`, `Email`, `Empresa`, `Ip`, `Ciudad`, `Hora`, `Fecha`, `Estado`) VALUES
(1, 'matias@inacap.cl', 'RIVAS', '::1', '', '09:57:58', '2019-08-30', 1),
(2, 'matias@inacap.cl', 'RIVAS', '::1', '', '22:33:52', '2019-08-30', 1),
(3, 'matias@inacap.cl', 'RIVAS', '::1', '', '23:02:32', '2019-08-30', 1),
(4, 'matias@inacap.cl', 'RIVAS', '::1', '', '23:19:16', '2019-08-30', 1),
(5, 'matias@inacap.cl', 'RIVAS', '::1', '', '23:19:48', '2019-08-30', 1),
(6, 'matias@inacap.cl', 'RIVAS', '192.168.8.103', '', '00:21:52', '2019-08-31', 1);
...
--
ALTER TABLE `communes`
  ADD CONSTRAINT `communes` FOREIGN KEY (`region_id`) REFERENCES `regions` (`id`);

--
-- Filtros para la tabla `ingreso`
--
ALTER TABLE `ingreso`
  ADD CONSTRAINT `ingreso` FOREIGN KEY (`Estado`) REFERENCES `estados` (`id_estado`);
COMMIT;
