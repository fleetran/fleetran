...
<head>
    ...
    <title>Admin mode - Fleetran</title>
...
?>
    ...
    -->
            <div class="sidebar-wrapper">
                <div class="logo">
                    <a href="admin.php" class="simple-text">Fleetran Admin</a>
                </div>
                <ul class="nav">
					<?php
				for($i=0; $i<count($nav); $i++){
					$e = $nav[$i];
					echo '<li class=';
					if(basename($_SERVER['PHP_SELF'])==$e->getUrl()){
					echo 'nav-item active';}else{echo 'nav-link';}echo'">
                        <a class="nav-link" href='.$e->getUrl().'>
                            <i class="'.$e->getIco().'"></i>
                            <p>'.$e->getNom().'</p>
                        </a>
                    </li>';
