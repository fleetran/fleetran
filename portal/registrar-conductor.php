      ...
      <div class="container-fluid">
		...
		<div class="form-group">
                <div class="form-label-group">
                  <input type="text" id="firstName" class="form-control" placeholder="Rut del conductor" required="required" autofocus="autofocus" name="txt_rut">
                  <label for="lastName">Rut del conductor</label>
                </div>
              </div>
			  <div class="form-row">
              <div class="col-md-6">
                <div class="form-label-group">
                  <input type="text" id="firstName" class="form-control" placeholder="Primer nombre" required="required" autofocus="autofocus" name="txt_nom1">
                  <label for="firstName">Primer nombre</label>
                </div>
              </div>
              <div class="col-md-6">
                <div class="form-label-group">
                  <input type="text" id="firstName" class="form-control" placeholder="Segundo nombre" required="required" autofocus="autofocus" name="txt_nom2">
			...
			<div class="form-row">
              <div class="col-md-6">
                <div class="form-label-group">
                  <input type="text" id="lastName" class="form-control" placeholder="Primer apellido" required="required" name="txt_ape1">
                  <label for="lastName">Primer apellido</label>
                </div>
              </div>
			  <div class="col-md-6">
                <div class="form-label-group">
                  <input type="text" id="lastName" class="form-control" placeholder="Segundo apellido" required="required" name="txt_ape2">
          ...
          <div class="form-group">
                <div class="form-label-group">
                  <input type="text" id="lastName" class="form-control" placeholder="Dirección" required="required"  name="txt_dir">
                  <label for="lastName">Dirección (ej: av. Nelson Pereira)</label>
                </div>
              </div>
			  <div class="form-row">
              <div class="col-md-6">
			...
			<h5>Documentación</h5>
			<br>
			<h6>Licencia de conducir (frontal)</h6>
			<input type="file" name="licencia1" accept=".jpg,.png" multiple><br><br>
			<h6>Licencia de conducir (posterior)</h6>
			<input type="file" name="licencia2" accept=".jpg,.png" multiple><br><br>
          <button class="btn btn-primary btn-block" name="btn_new_conductor" formaction="../class/procesar.php">Finalizar</button>
        </form>
      </div>
        </div>
      <!-- /.container-fluid -->
