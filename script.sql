...
Fecha date NOT NULL,
Estado int(1),
foreign key ingreso(Estado) references estados(id_estado)
);
...
INSERT INTO admin VALUES(1,'admin@fleetran.cl','e10adc3949ba59abbe56e057f20f883e');
INSERT INTO estados VALUES(1,'Ingreso exitoso'),(2,'Datos incorrectos'),(3,'Bloqueo de cuenta'),(4,'Caracteres invalidos'),(5,'Campos vacios'),(6,'Usuario sin licencia');
...
name varchar(255),
region_id int(10),
foreign key communes(region_id) references regions(id)
);
